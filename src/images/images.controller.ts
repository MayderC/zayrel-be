...
export class ImagesController {
   ...
   */
  @Patch(':imageId/main')
  async setMainImage(@Param('productId') productId: string, @Param('imageId') imageId: string) {
   ...
   */
  @Patch('reorder')
  async reorderImages(@Param('productId') productId: string, @Body('imageIds') imageIds: string[]) {
